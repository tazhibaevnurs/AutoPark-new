...
urlpatterns = [
    ...
    path('prodazha-motociklov/', include([
        path('', leads_views.MotorcycleSalesView.as_view(), name='motorcycle_sales'),
        path('success/', leads_views.motorcycle_sales_success_view, name='motorcycle_sales_success'),
    ])),
    ...
    path('contacts/', leads_views.ExpertQuestionView.as_view(), name='contacts'),
    path('contacts/success/', leads_views.contacts_success_view, name='contacts_success'),
    path('privacy-policy/', pages_views.privacy_policy, name='privacy_policy'),
    path('data-processing-policy/', pages_views.data_processing_policy, name='data_processing_policy'),
    path('terms-of-use/', pages_views.terms_of_use, name='terms_of_use'),
